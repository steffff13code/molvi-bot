...
def _help_text() -> str:
    return (
        ...
        "<b>2.</b> Дождитесь расшифровки (час записи ≈ 3 минуты).\n"
        ...
        "💳 Тарифы / Купить минуты — цены и лимит\n"
        "🛒 Купить диктофон — про устройство\n"
        "ℹ️ Помощь — эта справка\n\n"
        f"<b>Лимит:</b> {FREE_MINUTES} минут бесплатно, далее от {PRICE_PER_HOUR} ₽/час.\n"
        "<b>Форматы:</b> голосовые, MP3, M4A, WAV, OGG, FLAC, видео (MP4, MOV) и др.\n"
        "<b>Приватность:</b> мы не храним ваши файлы и расшифровки. Серверы в России (152-ФЗ).\n\n"
